  ...
  return (
    <section id="resume" className="py-20 bg-[#0F172A]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          className="max-w-3xl mx-auto glass-panel p-8 rounded-xl border border-white/5 flex flex-col md:flex-row items-center justify-between gap-8 hover:border-[#7C3AED]/40 transition-colors duration-300 shadow-xl"
